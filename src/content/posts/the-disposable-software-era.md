...
pubDate: 2026-01-30
draft: true
tags: ["ai", "software", "saas", "consulting"]
---

[Anthropic shipped Cowork](https://dev.to/with_attitude/anthropic-shipped-cowork-in-10-days-using-its-own-ai-heres-why-that-changes-everything-2i2j) in about 10 days using Claude Code itself. [Cursor's AI agents built a browser](https://www.theregister.com/2026/01/22/cursor_ai_wrote_a_browser/) - 3 million lines of code - in a week with no human intervention. These aren't startups trying to prove a point. These are the companies building the tools.
...
Now building is fast. [Anthropic reports 70-90% of code](https://fortune.com/2026/01/29/100-percent-of-code-at-anthropic-and-openai-is-now-ai-written-boris-cherny-roon/) at the company is written by AI. Claude Code grew from research preview to billion-dollar product in six months. Cursor hit $100M ARR faster than any company in history - 12 months.
...
a16z calls this "[disposable software](https://a16z.com/disposable-software/)" - applications that never justified engineering investment now make sense because the investment required has collapsed. The constraint is no longer ROI. It's imagination.
...
But I keep running into the same question: how long does this window stay open?
...
I don't know. The direction seems clear: these tools will eventually be usable by people without engineering backgrounds. The timeline is opaque. And the question for anyone considering this path is whether you're building a career or riding a wave.

## The Opposition Steelmanned

Before declaring SaaS dead, the counterarguments deserve serious treatment.

**Security is a real problem.** One analysis found 45% of AI-produced code contains security vulnerabilities. Another found 62% of AI-generated SaaS platforms lacked basic rate limiting. A UK study showed developers spent 41% more time debugging AI code in large systems. 16 of 18 CTOs in one survey reported production disasters from AI-generated code.
...
Bain's analysis is useful here: "Low automation + unique data = core strongholds." The CRM you built in a weekend won't replace Salesforce for companies that need 15 years of institutional knowledge encoded in their data model.
...
The question is how fast - and that uncertainty affects everyone's strategy differently.

For consultants: there's a window. How long it stays open is unclear. Betting on it is rational; betting the farm on it is risky.
...
No confident predictions here. Just a recognition that the ground is shifting - and the speed of that shift is something to watch, not something to bet your career on knowing in advance.
