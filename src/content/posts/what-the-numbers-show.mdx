...
But the most useful thing the rework data has surfaced so far isn't about the agents at all - it's about me. The sessions with the highest rework track back to sessions where I skipped the research or undercooked the specification. The metric is measuring my planning discipline as much as the model's reliability.
