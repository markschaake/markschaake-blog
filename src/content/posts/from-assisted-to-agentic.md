...
<a href="https://every.to/source-code/inside-the-ai-workflows-of-every-s-six-engineers" target="_blank" rel="noopener noreferrer">Every.to</a> documents something similar at a smaller scale - six engineers running four AI products, mornings for focused execution with established tools, afternoons for agent exploration, multiple AI instances running in parallel for different task streams. <a href="https://tweag.github.io/agentic-coding-handbook/" target="_blank" rel="noopener noreferrer">Tweag's Agentic Coding Handbook</a> codifies seven distinct workflows from spec-first development to TDD integration to auto-validation loops. The gap between "we have Copilot" and "we have structured agentic workflows" is mostly a gap of deliberate design, not capability.

---

What makes this harder to navigate is that the productivity gains are genuinely difficult to measure - and teams consistently misjudge them. The <a href="https://metr.org/blog/2025-07-10-early-2025-ai-experienced-os-dev-study/" target="_blank" rel="noopener noreferrer">METR study</a> from July 2025 found that experienced developers using AI tools took 19% longer on real tasks from their own codebases while believing they'd experienced a 20% speedup. The gap between perception and measurement was consistent across the study.

And the organizational dynamics compound the problem. <a href="https://jellyfish.co/blog/2025-ai-metrics-in-review/" target="_blank" rel="noopener noreferrer">Jellyfish analyzed over two million pull requests</a> and found that full AI adoption increased PRs merged per engineer by 113%, but review time increased by 91% - more code flowing through a review pipeline that wasn't designed for the volume. The <a href="https://www.faros.ai/blog/ai-software-engineering" target="_blank" rel="noopener noreferrer">Faros AI data</a> makes the disconnect explicit: 21% more tasks completed, 98% more PRs merged, and no correlation whatsoever with organizational-level delivery metrics.
...
I think the destination is more radical than most teams are ready to talk about. The shift isn't from writing code to writing code with AI assistance - it's from writing code to not writing code at all. Agents do the coding. Humans write specs, operate and fine-tune the agentic systems, and verify the output - though even verification keeps moving up in abstraction as agents take on more of that work too. Others are arriving at the same conclusion - _agentic engineering_ describes a fundamentally different job, not an incremental improvement to the old one.

If that's where this goes - and I believe it is - then large engineering teams as we know them are going to compress. Small groups of highly leveraged people replacing departments. There's probably a maximum effective team size for agentic engineering, and I suspect it's a surprisingly small number.
